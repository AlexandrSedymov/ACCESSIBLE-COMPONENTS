...
export const Home: React.FC = () => {
    return (
        <main className="home-container" role="main" id="main-content">
            ...
            <LinkSection links={[
            { label: "Reference book for creating accessible user interface elements", url: "https://handreichungen.bfit-bund.de/accessible-uie/" },
            { label: "DesOps system inspiration (U.S. Web Design System (USWDS))", url: "https://designsystem.digital.gov/components/overview/" },
            { label: "AREA patterns:", url: "https://www.w3.org/WAI/ARIA/apg/patterns/" },
            { label: "Web Content Accessibility Guidelines (WCAG) 2.2:", url: "https://www.w3.org/TR/WCAG22/" }]} />
        </main>
    );
};